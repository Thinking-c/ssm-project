package com.thinking.controller.system;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

import com.thinking.base.BaseController;
import com.thinking.config.Const;
import com.thinking.dao.model.system.Menu;
import com.thinking.dao.model.system.Role;
import com.thinking.dao.model.system.User;
import com.thinking.service.system.MenuService;
import com.thinking.service.system.RoleService;
import com.thinking.service.system.UserService;
import com.thinking.utils.*;
    ...
    public Object login() throws Exception {
        ...
        try {
            ...
            if (StringUtils.isBlank(userName)) {
                returnInfo = "missUser";
                returnMap.put("result", returnInfo);
                return JacksonUtil.bean2Json(returnMap);
            }

            if (StringUtils.isBlank(password)) {
                returnInfo = "missPassword";
                returnMap.put("result", returnInfo);
                return JacksonUtil.bean2Json(returnMap);
            }
            ...
            if (sessionCode.equalsIgnoreCase(code)) {
                String enPwd = new SimpleHash("SHA-1", userName, password).toString();
                pd.put("USERNAME", userName);
                pd.put("PASSWORD", enPwd);
                ...
                if (pd != null) {
                    ...
                    try {
                        ...
                        returnInfo = "identityError";
                    }
                } else {
                    returnInfo = "userOrPasswordError";
                }
            } else {
                returnInfo = "codeError";
            }
