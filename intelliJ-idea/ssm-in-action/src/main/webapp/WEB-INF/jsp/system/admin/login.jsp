            ...
            $.ajax({
                ...
                success: function (data) {
                    if ("success" == data.result) {
                        ...
                        $("#loginname").focus();
                    } else if ("missPassword" == data.result) {
                        $("#password").tips({
                            side: 1,
                            msg: "密码输入有误",
                            bg: '#FF5080',
                        ...
                        $("#password").focus();
                    } else if ("missCode" == data.result ||
                        "codeError" == data.result) {
                        $("#code").tips({
                            side: 1,
                            msg: "验证码输入有误",
                            bg: '#FF5080',
                        ...
                        $("#code").focus();
                    } else if ("identityError" == data.result
                        || "userOrPasswordError" == data.result) {
                        $("#loginname").tips({
                            side: 1,
                            msg: "用户名或者密码错误",
                            bg: '#FF5080',
