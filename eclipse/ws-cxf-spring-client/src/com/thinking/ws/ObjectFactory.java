 ...
 * generated in the com.thinking.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrderById_QNAME = new QName("http://ws.thinking.com/", "getOrderById");
    private final static QName _GetOrderByIdResponse_QNAME = new QName("http://ws.thinking.com/", "getOrderByIdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.thinking.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.thinking.com/", name = "getOrderById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.thinking.com/", name = "getOrderByIdResponse")
