 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://ws.thinking.com/", wsdlLocation = "http://192.168.1.196:8989/ws-demo/hellows?wsdl")
public class HelloWSImplService extends Service {
	...
	static {
		...
		try {
			url = new URL("http://192.168.1.196:8989/ws-demo/hellows?wsdl");
