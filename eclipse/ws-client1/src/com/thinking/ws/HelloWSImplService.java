 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://ws.thinking.com/", wsdlLocation = "file:/D:/IDE/eclipse-workspace/ws-client1/hellows.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://ws.thinking.com/", "HelloWSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/IDE/eclipse-workspace/ws-client1/hellows.wsdl");
    ...
    public HelloWSImpl getHelloWSImplPort() {
        return super.getPort(new QName("http://ws.thinking.com/", "HelloWSImplPort"), HelloWSImpl.class);
    }
    ...
    public HelloWSImpl getHelloWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.thinking.com/", "HelloWSImplPort"), HelloWSImpl.class, features);
    }
