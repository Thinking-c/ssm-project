 ...
 * <strong>2400�����������Ԥ��Web����</strong>������2300�������й����к�100�����Ϲ����������Ԥ�����ݡ�����ÿ2.5Сʱ�����Զ�����һ�Σ�׼ȷ�ɿ���<br
 * />
 * ʹ�ñ�վ WEB ������ע�������ӱ�վ��<a href="http://www.webxml.com.cn/" target=
 * "_blank">http://www.webxml.com.cn/</a> ��л��ҵ�֧�֣�<br />
 * <br />
 * <img alt="PDF" title="PDF file" src=
 * "http://www.webxml.com.cn/images/icon/pdf.gif" style="vertical-align:
 * middle;" />
 * <a href="http://www.webxml.com.cn/files/WeatherWsHelp.pdf" target=
 * "_blank">�ӿڰ����ĵ�</a> &nbsp;&nbsp;&nbsp;
 * <img alt="ZIP" title="ZIP file" src=
 * "http://www.webxml.com.cn/images/icon/zip.gif" style="vertical-align:
 * middle;" />
 * <a href="http://www.webxml.com.cn/files/about_city.zip">���ֳ��н��ܺ����򱳾�</a>
 * &nbsp;&nbsp;&nbsp; <img alt="ZIP" title="ZIP file" src=
 * "http://www.webxml.com.cn/images/icon/zip.gif" style="vertical-align:
 * middle;" />
 * <a href="http://www.webxml.com.cn/files/city_photo.zip">���ֳ���ͼƬ</a>
 * &nbsp;&nbsp;&nbsp; <img alt="HTML" title="HTML file" src=
 * "http://www.webxml.com.cn/images/icon/html.gif" style="vertical-align:
 * middle;" />
 ...
 * 
 */
@WebServiceClient(name = "WeatherWS", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/D:/IDE/eclipse-workspace/weather-client/weather.wsdl")
public class WeatherWS extends Service {
	...
	static {
		...
		try {
			url = new URL("file:/D:/IDE/eclipse-workspace/weather-client/weather.wsdl");
