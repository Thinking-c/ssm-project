 ...
 * 2018-09-03T13:27:07.573+08:00
 * Generated source version: 3.2.5
 *
 */
@WebServiceClient(name = "CentralSystemService",
                  wsdlLocation = "file:/D:/IDE/eclipse-workspace/ws-cxf-client/ocpp_centralsystemservice_1.5_final.wsdl",
...
public class CentralSystemService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/IDE/eclipse-workspace/ws-cxf-client/ocpp_centralsystemservice_1.5_final.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CentralSystemService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/IDE/eclipse-workspace/ws-cxf-client/ocpp_centralsystemservice_1.5_final.wsdl");
        }
        WSDL_LOCATION = url;
    }
