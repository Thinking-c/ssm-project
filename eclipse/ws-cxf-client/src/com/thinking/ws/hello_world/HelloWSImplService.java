 ...
 * 2018-08-14T15:59:49.564+08:00
 * Generated source version: 3.2.5
 *
 */
@WebServiceClient(name = "HelloWSImplService",
                  wsdlLocation = "http://192.168.1.196:8888/ws-demo/hellows?wsdl",
                  targetNamespace = "http://hello_world.ws.thinking.com/")
public class HelloWSImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://hello_world.ws.thinking.com/", "HelloWSImplService");
    public final static QName HelloWSImplPort = new QName("http://hello_world.ws.thinking.com/", "HelloWSImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.1.196:8888/ws-demo/hellows?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWSImplService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://192.168.1.196:8888/ws-demo/hellows?wsdl");
        }
        WSDL_LOCATION = url;
    }
